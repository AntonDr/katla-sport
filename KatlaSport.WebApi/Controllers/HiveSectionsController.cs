...
namespace KatlaSport.WebApi.Controllers
{
    ...
    public class HiveSectionsController : ApiController
    {
        ...
        [SwaggerResponse(HttpStatusCode.NotFound)]
        [SwaggerResponse(HttpStatusCode.InternalServerError)]
        public async Task<IHttpActionResult> UpdateHiveSectionAsync([FromUri] int hiveSectionId, [FromBody] UpdateHiveSectionRequest updateRequest)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [SwaggerResponse(HttpStatusCode.NotFound)]
        [SwaggerResponse(HttpStatusCode.InternalServerError)]
        public async Task<IHttpActionResult> DeleteHiveSectionAsync([FromUri] int hiveSectionId)
        {
